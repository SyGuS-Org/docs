...
The purpose of an attribute is to mark a term with 
special properties, which impact the expected result of later commands.
...
Several attributes are standardized by the SMT-LIB standard.
