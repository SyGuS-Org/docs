...
then any term in the output logic may be given in the body of a solution for $S$.
...
Generally, features are not expressible in an input or output logic
and are parametric with respect to them.
\end{enumerate}
