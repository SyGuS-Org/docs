...
\paragraph{Binary Constants ($\hexconst$)}
Binary constants are written in their
traditional representation, with ${\tt \#b}$
followed by a non-empty sequence of bits $\left[{\tt 0}-{\tt 1}\right]$.

\paragraph{String Constant ($\stringconst$)}
