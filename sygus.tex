...
\rem{Syntax for synth-fun}

\rem{Remove declare-primed-var}

\rem{set-options to set-option}

\rem{Remove Enum}

\rem{Syntax for terms assumes smt2: especially BitVec and 3 argument let}

\rem{No input/local variable}
...
\subsection{Setting the Logic and Solver Options}
