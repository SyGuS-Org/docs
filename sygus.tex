...
which restricts or extends the types of commands that are allowed in a SyGuS input,
and may further restrict the terms or grammars allowed by the input and output logics.
Generally, features are not expressible as an input or output logic
