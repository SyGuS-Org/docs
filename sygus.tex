...
In other words, when this command has $S$ as an argument, this
indicates that that terms in $S$ are 
permitted in constraints, grammars and solutions, but they are
are restricted to be quantifier-free.
As a consequence, 
the synthesis conjectures allowed by default for logics specified
