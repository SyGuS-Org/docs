...
logic with additional restrictions.
\end{enumerate}
Both components of the logic affect the kinds of terms that may appear
in constraints and in grammars.
The purpose of the extended logic is to specify
restrictions that are not expressible in a base logic
...
They indicate (respectively) whether
