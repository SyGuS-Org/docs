...
\begin{alignat*}{1}
 & \begin{array}{rcl}
 \feature & ::= & \efwddeclskwd\mbox{ }|\mbox{ }\erecursionkwd\mbox{ }|\mbox{ }\equantifierskwd
\end{array}
\end{alignat*}
...
The feature set component of the default SyGuS logic is the empty set,
in other words, forward declarations, recursion, and arbitrary quantification
