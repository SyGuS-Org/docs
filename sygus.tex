...
see Appendix~\ref{ssec:smt-logic}.
...
Sorts may be defined by theories (see examples in Appendix~\ref{ssec:smt-logics})
...
Examples of the latter are given in Appendix~\ref{ssec:smt-logics}.
