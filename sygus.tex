...
%is not allowed unless $\ffwddeclskwd$ is enabled in the extended logic.
...
corresponds to the given by SMT-LIB for theories $T$.
...
Thus, we adopt the proposed standard~\cite{smtlibStrings}
