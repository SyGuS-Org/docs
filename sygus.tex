...
A term $t$ is not allowed by SyGuS background logic $\slogic$ 
...
A grammar $G$ is not allowed by a SyGuS background logic $\slogic$ if
...
A grammar $G$ for function-to-synthesize $f$ is not allowed by a SyGuS background logic $\slogic$
