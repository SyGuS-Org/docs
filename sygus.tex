...
\begin{alignat*}{1}
 & \begin{array}{rcl}
 \feature & ::= & \equantifierskwd\mbox{ }|\mbox{ }\efwddeclskwd\mbox{ }|\mbox{ }\erecursionkwd
\end{array}
\end{alignat*}
...
The base logic of the default SyGuS logic is the empty logic,
...
Their syntax is given by the enumeration in Section~\ref{ssec:syntax-features}.
The meaning of the features standardized by this document are listed below.
\begin{itemize}
...
Formal definition of these features are given in references in the 
remainder of this section.

The features set of the default SyGuS logic is the empty set. It can be modified
