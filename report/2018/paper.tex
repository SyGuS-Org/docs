...
\newcommand{\inliststyle}[1]{\textbf{\small #1}}
...
\author{
  ...
  \and
	Dana Fisman
	\institute{Ben-Gurion University, Israel}
	\email{dana@cs.bgu.ac.il}
  \and
	Saswat Padhi
  ...
  \and
	Rishabh Singh
	\institute{Google Brain, USA}
	\email{rising@google.com}
  \and
	Abhishek Udupa
	\institute{Microsoft, USA}
	\email{abudup@microsoft.com}
}
...
\newcommand{\horndini}{\textsc{Horndini}}
