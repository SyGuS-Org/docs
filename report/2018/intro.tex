...
\begin{itemize}[topsep=0.25em]
    \item \Cref{sec:participation} briefly describes the benchmarks and the key idea behind the submitted solvers.
    \item \Cref{sec:exp-set} provides details on the experimental setup.
    \item \Cref{sec:comp-results} gives an overview of the results per track.
    \item \Cref{sec:benchs-pres} provides details on the results, given from a single benchmark perspective.
    \item \Cref{sec:discussion} concludes the report with some key takeaway points.
\end{itemize}
