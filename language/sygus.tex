...
\begin{lstlisting}[language=SyGuS-Desugar]
($\constraintoraclekwd$ (($x_1$ $\sigma_1$)$\ldots$($x_n$ $\sigma_n$)) (($x$ $\sigma$)) (= ($F$ $x_1$ $\ldots$ $x_n$) $x$) $N$)
\end{lstlisting}
...
\begin{lstlisting}[language=SyGuS-Desugar]
($\constraintoraclekwd$ (($x_1$ $\sigma_1$)$\ldots$($x_n$ $\sigma_n$)) (($x$ $\sigma$)) (not (= ($F$ $x_1$ $\ldots$ $x_n$) $x$)) $N$)
\end{lstlisting}
