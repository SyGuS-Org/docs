...
if $r$ contains no free occurrences of non-terminal symbols and
it is possible to construct a sequence of terms
$s_1, \ldots, s_n$
...
However, 
by the definition of our restrictions on grammars in Section~\ref{ssec:logicr-grammrs},
