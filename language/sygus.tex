...
By convention quantifiers are always included in the logic
since the overall synthesis conjecture specified by the
...
term allowed in the output logic those sort
is the return sort of $f$.
\end{enumerate}
%\rem{More}
