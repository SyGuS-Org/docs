...
The definition above covers cases where $f_1, \ldots, f_n$
may have recursive definitions or references to forward declarations.
A formal description of $T$-valid formulas that contain these kinds of
functions assumes the semantics for
(defined) macros and recursive functions in SMT-LIB.
