...
\begin{enumerate}
\item An \emph{input logic}, which can be set via a $\setlogickwd$ command.
...
\item An \emph{output logic}, which can be set via a $\setlogickwd$ command
which, like input logics,
