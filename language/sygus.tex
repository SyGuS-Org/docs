...
the definition given in the SMT-LIB standard~\cite{BarFT-RR-17}.
}
...
(for details on the default SyGuS logic, see \cref{sec:sygus-logic}).
%that is, 
...
The expected output from the synthesis solver is covered in \cref{sec:output}.
\end{itemize}
