...
it satisfies the semantic and syntactic restrictions given by
the current state, as well as specifying values $c_1, \ldots, c_j$ that
are consistent interpretations of $t_1, \ldots, t_j$.
...
satisfies semantic specifications only if 
$( \lambda X_1 \ldotp t_1, \ldots, \lambda X_n \ldotp t_n)$
satisfies the semantic specifications for
for $\exists f_1, \ldots, f_n. \Psi_{o}$.
