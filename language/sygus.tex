...
\rem{Datatypes}
\subsection{Datatypes with Linear Arithmetic}
...
(check-synth)
\end{lstlisting}
In this example, the logic is set to the
logic of datatypes with linear integer arithmetic ${\tt DTLIA}$.
...
\end{lstlisting}
In other words, the solution for $f$ returns zero whenever its
