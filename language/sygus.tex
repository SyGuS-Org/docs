...
The text file should contain a list $\paren{v_1 \ldots v_n}$ specifying values for each argument to the oracle. The oracle will return a list $\paren{v_{n+1} \ldots v_{n+m}}$ specifying values for the return values of the oracle.\\

\noindent Consider an oracle declared with the following command:\\\\
$\paren{\constraintoraclekwd\mbox{ } N \mbox{ }
\paren{\paren{x_1\mbox{ }\sigma_1} \ldots \paren{x_n\mbox{ }\sigma_n}}\mbox{ }
\paren{\paren{x_{n+1}\mbox{ }\sigma_{n+1}} \ldots \paren{x_{n+m}\mbox{ }\sigma_{n+m}}}  \mbox{ } t}$ \\
